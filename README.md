...
Kronos 是一个基于 PyQt5 开发的比特币交易机器人桌面应用，集成了 OKX 交易所 API，仅支持OKEX交易所BTC/USDT交易，提供实时市场数据监控、自动化交易策略、风险控制管理和详细的交易日志功能。
...
2. **数据展示模块**
   - 实时BTC 15分钟K线图
   - 账户信息面板（余额、持仓、收益率（未实现）、未实现盈亏（未实现））
   - 持仓详情表格
   - 价格走势图表
...
5. **模型配置**
   - 开源模型使用BTC 15分钟K训练强化，请谨慎使用
   - 模型下载地址：链接: https://pan.baidu.com/s/1BNvcesSDbR-Oxafwwe7sUQ?pwd=ffj3 提取码: ffj3

6. **网络代理配置**
   - 可使用Squid+境外服务器自行搭建代理
   - okx_api中配置代理地址和端口号
